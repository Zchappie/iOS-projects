...
struct DefaultValues {
    ...
    // Private(set) property means publicly readable, but its setter is private
    ...
    init() {
        ...
        var italian = Category(name: "Italian")
        var middleEastern = Category(name: "Middle Eastern")
        ...
        categories = [italian, middleEastern]
        recipes = [margherita, spaghettiCarbonara, hummus, falafel, shawarma]
    }
}
